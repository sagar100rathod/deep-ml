...
class NeuralNetTask(Task):
    ...
    def train_step(self, x, y, *args, **kwargs):
        return self.predict_batch(x, y, *args, **kwargs)
    ...
    def evaluate(self, loader: torch.utils.data.DataLoader, metrics: Dict[str, torch.nn.Module] = None,
        ...
        for batch_index, (x, y) in enumerate(loader):
            ...
            outputs = self.eval_step(x, y, non_blocking)
...
class Segmentation(NeuralNetTask):
    ...
    def show_predictions(self, loader: torch.utils.data.DataLoader,
        ...
        with torch.no_grad():
            ...
            predictions = self.eval_step(x, targets).cpu()
...
class ImageRegression(NeuralNetTask):
    ...
    def show_predictions(self, loader: torch.utils.data.DataLoader,
        ...
        with torch.no_grad():
            ...
            predictions = self.eval_step(x, y)
